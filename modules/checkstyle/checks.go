...
doUnconditional();`},
	"EqualsHashCode": {Category: "coding",
		Description: "Any class which overrides either equals() or hashcode() must override the other.",
	...
	"InnerAssignment": {Category: "coding",
		Description: "You should not assign variables in sub-expressions, with exceptions to assignments in 'for' and 'while' statements.",
		Rationale:   "This makes it harder to see all the places where a variable is set.",
		Suggestion:  "Move the variable assignment outside of the sub-expression."},
	...
	"RequireThis": {Category: "coding",
		Description: "You must include 'this.' when referring to instance variables and methods.",
	...
	"MethodParamPad": {Category: "whitespace",
		Description: "Avoid unnecessary whitespace between the method identifier and the open (left) parenthesis of the parameter list."},
	"ParenPad": {Category: "whitespace",
		Description: "Avoid unnecessary whitespace in parentheses."},
	...
	"CommentsIndentation": {Category: "misc",
		...
		Suggestion:  "Fix the indentation of the comment to match the indentation level of the surrounding code."},
}
